...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Rent house information System-My Properties</title>
</head>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 widget--about">
                            <div class="widget--content">
                                <div class="footer--logo">
                                    <img src="assets/images/logo/logo-dark3m.png" alt="logo">
                                </div>
                                <p>Panikhaiti Railgate,Narangi chandrapur road, Assam, India <br>Pin 781026</p>
                                <div class="footer--contact">
                                    <ul class="list-unstyled mb-0">
                                        <li>+91 98546 82686</li>
                                        <li><a href="rentsolutions.com">rentsolutions.com</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row footer--bar">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <span>© 2022 Rent Solutions, All Rights Reserved.</span>
                        </div>
