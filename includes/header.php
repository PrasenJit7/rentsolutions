            ...
            <nav id="primary-menu" class="navbar navbar-fixed-top">
                ...
                <span class="icon-bar"></span>
                 ...
                 <a class="logo" href="index.php">
                    <strong style="color:#34495e; font-size:18px;">RENT SOLUTIONS</strong>
                </a>
                    </div>
                                                    ...
                                                    <div class="tab-pane fade in active" id="login">
                                                        <div class="signup-form-container text-center">
                                                            <form class="mb-0" method="post" name="signin">
                                                                ...
                                                                <div class="or-text">
                                                                <span style="color: blue">RENT SOLUTIONS</span>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane" id="signup">
                                                        <form class="mb-0" method="post" name="signup">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <input type="radio" name="usertype" value="2" >Owner &nbsp; &nbsp; <input type="radio" name="usertype" value="3">User
                                                            </div>
                                                            <!-- .form-group end -->
